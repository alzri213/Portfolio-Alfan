...
export const SOCIAL_MEDIA: SocialMediaProps[] = [
  ...
  },
  {
    ...
    name: "instagram",
    href: "https://www.instagram.com/zreekx?igsh=ZmJjNXE4a3Z0bTF4",
  ...
  },
  {
    ...
    name: "Youtube",
    href: "https://youtube.com/@alzrigamesyt?si=LlUiN9ffN5Z2d21V",
    icon: <BsYoutube size={iconSize} />,
    backgroundIcon: <BsYoutube size={backgroundIconSize} />,
  ...
  },
  {
    ...
    name: "tiktok",
    href: "https://www.tiktok.com/@alzri_nocounter?_t=ZS-8vT0XOdCqKG&_r=1",
  ...
  },
  {
    ...
    name: "github",
    href: "https://github.com/alzri213",
